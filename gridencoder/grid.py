...
class GridEncoder(nn.Module):
    def __init__(self, input_dim=3, num_levels=16, level_dim=2, per_level_scale=2, base_resolution=16, log2_hashmap_size=19, \
                 desired_resolution=None, gridtype='tiled', align_corners=True, interpolation='linear'):
        super().__init__()
        ...
        resolutions = torch.from_numpy(np.array(resolutions, dtype=np.int32))
